...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_FLOAT32_BOUNDED_ARRAY__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_FLOAT32_BOUNDED_ARRAY__STRUCT_HPP_
...
struct TestFloat32BoundedArray_
{
  ...
  explicit TestFloat32BoundedArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TestFloat32BoundedArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : data(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_FLOAT32_BOUNDED_ARRAY__STRUCT_HPP_
