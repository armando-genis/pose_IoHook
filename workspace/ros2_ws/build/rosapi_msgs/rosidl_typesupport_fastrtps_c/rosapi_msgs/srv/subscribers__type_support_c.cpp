...
// already included above
// #include "rosidl_generator_c/string.h"  // subscribers
// already included above
// #include "rosidl_generator_c/string_functions.h"  // subscribers
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: subscribers
  {
    ...
    if (ros_message->subscribers.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->subscribers);
    }
