...
#include "rosbridge_test_msgs/srv/test_empty__rosidl_typesupport_fastrtps_cpp.hpp"
#include "rosbridge_test_msgs/srv/test_empty__struct.hpp"
...
static size_t _TestEmpty_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_TestEmpty_Request(full_bounded, 0);
}
...
static size_t _TestEmpty_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_TestEmpty_Response(full_bounded, 0);
}
