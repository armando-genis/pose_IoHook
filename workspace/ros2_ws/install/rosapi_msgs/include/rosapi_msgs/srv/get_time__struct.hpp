...
#ifndef ROSAPI_MSGS__SRV__GET_TIME__STRUCT_HPP_
#define ROSAPI_MSGS__SRV__GET_TIME__STRUCT_HPP_
...
struct GetTime_Request_
{
  ...
  explicit GetTime_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetTime_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct GetTime_Response_
{
  ...
  explicit GetTime_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : time(_init)
  {
    (void)_init;
  }

  explicit GetTime_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : time(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // ROSAPI_MSGS__SRV__GET_TIME__STRUCT_HPP_
