...
#include "rosbridge_test_msgs/srv/test_multiple_request_fields__rosidl_typesupport_fastrtps_c.h"
...
static size_t _TestMultipleRequestFields_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestMultipleRequestFields_Request(
    full_bounded, 0);
}
...
static size_t _TestMultipleRequestFields_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestMultipleRequestFields_Response(
    full_bounded, 0);
}
