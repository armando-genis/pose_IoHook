...
#include "rosapi_msgs/srv/topics_for_type__rosidl_typesupport_fastrtps_c.h"
...
static size_t _TopicsForType_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosapi_msgs__srv__TopicsForType_Request(
    full_bounded, 0);
}
...
// already included above
// #include "rosidl_generator_c/string.h"  // topics
// already included above
// #include "rosidl_generator_c/string_functions.h"  // topics
...
static size_t _TopicsForType_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosapi_msgs__srv__TopicsForType_Response(
    full_bounded, 0);
}
