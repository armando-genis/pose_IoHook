...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_NESTED_BOUNDED_ARRAY__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_NESTED_BOUNDED_ARRAY__STRUCT_HPP_
...
// Member 'data'
#include "rosbridge_test_msgs/msg/test_float32_bounded_array__struct.hpp"
...
struct TestNestedBoundedArray_
{
  ...
  explicit TestNestedBoundedArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : data(_init)
  {
    (void)_init;
  }

  explicit TestNestedBoundedArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : data(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_NESTED_BOUNDED_ARRAY__STRUCT_HPP_
