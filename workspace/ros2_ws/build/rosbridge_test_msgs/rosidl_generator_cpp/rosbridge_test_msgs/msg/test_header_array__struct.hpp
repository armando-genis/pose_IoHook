...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER_ARRAY__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER_ARRAY__STRUCT_HPP_
...
struct TestHeaderArray_
{
  ...
  explicit TestHeaderArray_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit TestHeaderArray_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
  ...
  using _header_type =
    std::vector<std_msgs::msg::Header_<ContainerAllocator>, typename ContainerAllocator::template rebind<std_msgs::msg::Header_<ContainerAllocator>>::other>;
  _header_type header;

  // setters for named parameter idiom
  Type & set__header(
    const std::vector<std_msgs::msg::Header_<ContainerAllocator>, typename ContainerAllocator::template rebind<std_msgs::msg::Header_<ContainerAllocator>>::other> & _arg)
  {
    this->header = _arg;
    return *this;
  }
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER_ARRAY__STRUCT_HPP_
