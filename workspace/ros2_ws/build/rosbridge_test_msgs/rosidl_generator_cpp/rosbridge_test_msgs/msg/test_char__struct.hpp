...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_CHAR__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_CHAR__STRUCT_HPP_
...
struct TestChar_
{
  ...
  explicit TestChar_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit TestChar_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_CHAR__STRUCT_HPP_
