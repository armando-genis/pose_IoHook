...
#ifndef ROSAPI_MSGS__SRV__GET_PARAM__STRUCT_H_
#define ROSAPI_MSGS__SRV__GET_PARAM__STRUCT_H_
...
typedef struct rosapi_msgs__srv__GetParam_Request
{
  ...
  rosidl_generator_c__String default_value;
...
#endif  // ROSAPI_MSGS__SRV__GET_PARAM__STRUCT_H_
