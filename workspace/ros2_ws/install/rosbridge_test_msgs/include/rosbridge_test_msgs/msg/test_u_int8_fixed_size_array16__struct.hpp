...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_U_INT8_FIXED_SIZE_ARRAY16__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_U_INT8_FIXED_SIZE_ARRAY16__STRUCT_HPP_
...
struct TestUInt8FixedSizeArray16_
{
  ...
  explicit TestUInt8FixedSizeArray16_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TestUInt8FixedSizeArray16_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : data(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_U_INT8_FIXED_SIZE_ARRAY16__STRUCT_HPP_
