...
#include <stddef.h>
#include "rosapi_msgs/srv/subscribers__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_service_members = {
  "rosapi_msgs__srv",  // service namespace
  "Subscribers",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_Request_message_type_support_handle,
  NULL  // response message
  // rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_Response_message_type_support_handle
};

static rosidl_service_type_support_t rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_service_type_support_handle = {
  0,
  &rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi_msgs, srv, Subscribers)() {
  if (!rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_service_type_support_handle.typesupport_identifier) {
    rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_service_type_support_handle.data;
  ...
  return &rosapi_msgs__srv__subscribers__rosidl_typesupport_introspection_c__Subscribers_service_type_support_handle;
}
