...
#ifndef ROSAPI_MSGS__SRV__GET_ROS_VERSION__STRUCT_H_
#define ROSAPI_MSGS__SRV__GET_ROS_VERSION__STRUCT_H_
...
{
  uint8_t version;
  rosidl_generator_c__String distro;
...
#endif  // ROSAPI_MSGS__SRV__GET_ROS_VERSION__STRUCT_H_
