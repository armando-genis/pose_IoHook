...
#ifndef ROSBRIDGE_TEST_MSGS__SRV__TEST_NESTED_SERVICE__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__SRV__TEST_NESTED_SERVICE__STRUCT_HPP_
...
struct TestNestedService_Request_
{
  ...
  explicit TestNestedService_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init)
  {
    (void)_init;
  }

  explicit TestNestedService_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_alloc, _init)
  {
    (void)_init;
  }
...
struct TestNestedService_Response_
{
  ...
  explicit TestNestedService_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : data(_init)
  {
    (void)_init;
  }

  explicit TestNestedService_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : data(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // ROSBRIDGE_TEST_MSGS__SRV__TEST_NESTED_SERVICE__STRUCT_HPP_
