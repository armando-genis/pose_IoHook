...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_FLOAT32_ARRAY__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_FLOAT32_ARRAY__STRUCT_HPP_
...
struct TestFloat32Array_
{
  ...
  explicit TestFloat32Array_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit TestFloat32Array_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_FLOAT32_ARRAY__STRUCT_HPP_
