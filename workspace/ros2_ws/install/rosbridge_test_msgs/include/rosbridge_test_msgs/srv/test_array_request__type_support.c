...
#include <stddef.h>
#include "rosbridge_test_msgs/srv/test_array_request__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_service_members = {
  "rosbridge_test_msgs__srv",  // service namespace
  "TestArrayRequest",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_Request_message_type_support_handle,
  NULL  // response message
  // rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_Response_message_type_support_handle
};

static rosidl_service_type_support_t rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_service_type_support_handle = {
  0,
  &rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosbridge_test_msgs, srv, TestArrayRequest)() {
  if (!rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_service_type_support_handle.typesupport_identifier) {
    rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_service_type_support_handle.data;
  ...
  return &rosbridge_test_msgs__srv__test_array_request__rosidl_typesupport_introspection_c__TestArrayRequest_service_type_support_handle;
}
