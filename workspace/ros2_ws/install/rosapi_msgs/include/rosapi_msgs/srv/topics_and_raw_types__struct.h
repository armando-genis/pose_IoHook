...
#ifndef ROSAPI_MSGS__SRV__TOPICS_AND_RAW_TYPES__STRUCT_H_
#define ROSAPI_MSGS__SRV__TOPICS_AND_RAW_TYPES__STRUCT_H_
...
{
  rosidl_generator_c__String__Sequence topics;
  rosidl_generator_c__String__Sequence types;
  rosidl_generator_c__String__Sequence typedefs_full_text;
...
#endif  // ROSAPI_MSGS__SRV__TOPICS_AND_RAW_TYPES__STRUCT_H_
