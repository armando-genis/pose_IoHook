...
#ifndef ROSBRIDGE_TEST_MSGS__SRV__TEST_MULTIPLE_RESPONSE_FIELDS__STRUCT_H_
#define ROSBRIDGE_TEST_MSGS__SRV__TEST_MULTIPLE_RESPONSE_FIELDS__STRUCT_H_
...
typedef struct rosbridge_test_msgs__srv__TestMultipleResponseFields_Response
{
  int32_t int_value;
  float float_value;
  rosidl_generator_c__String string;
  bool bool_value;
...
#endif  // ROSBRIDGE_TEST_MSGS__SRV__TEST_MULTIPLE_RESPONSE_FIELDS__STRUCT_H_
