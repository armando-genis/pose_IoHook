...
#ifndef ROSAPI_MSGS__SRV__SERVICE_PROVIDERS__STRUCT_HPP_
#define ROSAPI_MSGS__SRV__SERVICE_PROVIDERS__STRUCT_HPP_
...
struct ServiceProviders_Request_
{
  ...
  explicit ServiceProviders_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ServiceProviders_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : service(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct ServiceProviders_Response_
{
  ...
  explicit ServiceProviders_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit ServiceProviders_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // ROSAPI_MSGS__SRV__SERVICE_PROVIDERS__STRUCT_HPP_
