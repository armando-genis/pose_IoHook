...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER_TWO__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER_TWO__STRUCT_HPP_
...
struct TestHeaderTwo_
{
  ...
  explicit TestHeaderTwo_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit TestHeaderTwo_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER_TWO__STRUCT_HPP_
