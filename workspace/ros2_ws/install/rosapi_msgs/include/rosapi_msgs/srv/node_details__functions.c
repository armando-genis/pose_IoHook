...
rosapi_msgs__srv__NodeDetails_Response__init(rosapi_msgs__srv__NodeDetails_Response * msg)
{
  ...
  // subscribing
  if (!rosidl_generator_c__String__Sequence__init(&msg->subscribing, 0)) {
    rosapi_msgs__srv__NodeDetails_Response__fini(msg);
    return false;
  }
  // publishing
  if (!rosidl_generator_c__String__Sequence__init(&msg->publishing, 0)) {
    rosapi_msgs__srv__NodeDetails_Response__fini(msg);
    return false;
  }
  // services
...
rosapi_msgs__srv__NodeDetails_Response__fini(rosapi_msgs__srv__NodeDetails_Response * msg)
{
  ...
  // subscribing
  rosidl_generator_c__String__Sequence__fini(&msg->subscribing);
  // publishing
  rosidl_generator_c__String__Sequence__fini(&msg->publishing);
  // services
