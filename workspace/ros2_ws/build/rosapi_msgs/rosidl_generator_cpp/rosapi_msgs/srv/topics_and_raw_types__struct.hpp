...
#ifndef ROSAPI_MSGS__SRV__TOPICS_AND_RAW_TYPES__STRUCT_HPP_
#define ROSAPI_MSGS__SRV__TOPICS_AND_RAW_TYPES__STRUCT_HPP_
...
struct TopicsAndRawTypes_Request_
{
  ...
  explicit TopicsAndRawTypes_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TopicsAndRawTypes_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct TopicsAndRawTypes_Response_
{
  ...
  explicit TopicsAndRawTypes_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit TopicsAndRawTypes_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // ROSAPI_MSGS__SRV__TOPICS_AND_RAW_TYPES__STRUCT_HPP_
