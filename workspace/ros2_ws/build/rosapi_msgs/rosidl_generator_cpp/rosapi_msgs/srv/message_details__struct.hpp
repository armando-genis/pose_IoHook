...
#ifndef ROSAPI_MSGS__SRV__MESSAGE_DETAILS__STRUCT_HPP_
#define ROSAPI_MSGS__SRV__MESSAGE_DETAILS__STRUCT_HPP_
...
struct MessageDetails_Request_
{
  ...
  explicit MessageDetails_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit MessageDetails_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : type(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
struct MessageDetails_Response_
{
  ...
  explicit MessageDetails_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit MessageDetails_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // ROSAPI_MSGS__SRV__MESSAGE_DETAILS__STRUCT_HPP_
