...
#ifndef ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENTS__STRUCT_HPP_
#define ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENTS__STRUCT_HPP_
...
// Member 'clients'
#include "rosbridge_msgs/msg/connected_client__struct.hpp"
...
struct ConnectedClients_
{
  ...
  explicit ConnectedClients_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit ConnectedClients_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
  ...
  using _clients_type =
    std::vector<rosbridge_msgs::msg::ConnectedClient_<ContainerAllocator>, typename ContainerAllocator::template rebind<rosbridge_msgs::msg::ConnectedClient_<ContainerAllocator>>::other>;
  _clients_type clients;

  // setters for named parameter idiom
  Type & set__clients(
    const std::vector<rosbridge_msgs::msg::ConnectedClient_<ContainerAllocator>, typename ContainerAllocator::template rebind<rosbridge_msgs::msg::ConnectedClient_<ContainerAllocator>>::other> & _arg)
  {
    this->clients = _arg;
    return *this;
  }
...
#endif  // ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENTS__STRUCT_HPP_
