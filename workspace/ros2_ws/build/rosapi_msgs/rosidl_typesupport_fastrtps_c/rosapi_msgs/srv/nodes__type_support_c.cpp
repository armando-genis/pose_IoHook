...
#include "rosidl_generator_c/string.h"  // nodes
#include "rosidl_generator_c/string_functions.h"  // nodes
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->nodes);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->nodes, size)) {
