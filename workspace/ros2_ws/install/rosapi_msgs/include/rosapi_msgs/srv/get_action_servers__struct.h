...
#ifndef ROSAPI_MSGS__SRV__GET_ACTION_SERVERS__STRUCT_H_
#define ROSAPI_MSGS__SRV__GET_ACTION_SERVERS__STRUCT_H_
...
{
  rosidl_generator_c__String__Sequence action_servers;
...
#endif  // ROSAPI_MSGS__SRV__GET_ACTION_SERVERS__STRUCT_H_
