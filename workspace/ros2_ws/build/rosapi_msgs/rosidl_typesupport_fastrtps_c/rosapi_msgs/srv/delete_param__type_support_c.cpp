...
static size_t _DeleteParam_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosapi_msgs__srv__DeleteParam_Request(
    full_bounded, 0);
}
...
static size_t _DeleteParam_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosapi_msgs__srv__DeleteParam_Response(
    full_bounded, 0);
}
