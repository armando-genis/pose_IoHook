...
static size_t _TestNestedService_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestNestedService_Request(
    full_bounded, 0);
}
...
#include "std_msgs/msg/float64__functions.h"  // data
...
static size_t _TestNestedService_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestNestedService_Response(
    full_bounded, 0);
}
