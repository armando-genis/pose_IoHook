...
#ifndef ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENT__STRUCT_H_
#define ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENT__STRUCT_H_
...
{
  rosidl_generator_c__String ip_address;
...
#endif  // ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENT__STRUCT_H_
