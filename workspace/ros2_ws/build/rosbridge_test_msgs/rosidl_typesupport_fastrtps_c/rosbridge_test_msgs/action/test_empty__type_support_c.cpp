...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_Feedback(
    full_bounded, 0);
}
...
// already included above
// #include "rosbridge_test_msgs/action/test_empty__functions.h"  // goal
...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_GetResult_Request(
    full_bounded, 0);
}
...
// already included above
// #include "rosbridge_test_msgs/action/test_empty__functions.h"  // result
...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_GetResult_Response(
    full_bounded, 0);
}
...
// already included above
// #include "rosbridge_test_msgs/action/test_empty__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/uuid__functions.h"  // goal_id
...
{
  return max_serialized_size_rosbridge_test_msgs__action__TestEmpty_FeedbackMessage(
    full_bounded, 0);
}
