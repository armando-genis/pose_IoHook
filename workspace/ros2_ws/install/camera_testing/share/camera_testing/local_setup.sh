...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/camera_testing"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/camera_testing/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/camera_testing/environment/path.sh"
