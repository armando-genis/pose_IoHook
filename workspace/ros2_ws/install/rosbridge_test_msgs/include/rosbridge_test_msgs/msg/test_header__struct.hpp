...
#ifndef ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER__STRUCT_HPP_
...
struct TestHeader_
{
  ...
  explicit TestHeader_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit TestHeader_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // ROSBRIDGE_TEST_MSGS__MSG__TEST_HEADER__STRUCT_HPP_
