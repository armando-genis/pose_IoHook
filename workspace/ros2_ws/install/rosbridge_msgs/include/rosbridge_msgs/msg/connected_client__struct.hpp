...
#ifndef ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENT__STRUCT_HPP_
#define ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENT__STRUCT_HPP_
...
struct ConnectedClient_
{
  ...
  explicit ConnectedClient_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit ConnectedClient_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : ip_address(_alloc),
...
#endif  // ROSBRIDGE_MSGS__MSG__CONNECTED_CLIENT__STRUCT_HPP_
