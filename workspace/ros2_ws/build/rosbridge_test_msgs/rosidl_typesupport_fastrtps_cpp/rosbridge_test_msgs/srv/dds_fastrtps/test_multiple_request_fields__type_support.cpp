...
{
  return max_serialized_size_TestMultipleRequestFields_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_TestMultipleRequestFields_Response(full_bounded, 0);
}
