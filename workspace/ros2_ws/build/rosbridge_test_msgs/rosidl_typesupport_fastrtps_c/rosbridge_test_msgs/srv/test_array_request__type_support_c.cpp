...
#include "rosbridge_test_msgs/srv/test_array_request__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // int_values
#include "rosidl_generator_c/primitives_sequence_functions.h"  // int_values
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: int_values
  {
    ...
    if (ros_message->int_values.data) {
      rosidl_generator_c__int32__Sequence__fini(&ros_message->int_values);
    }
    if (!rosidl_generator_c__int32__Sequence__init(&ros_message->int_values, size)) {
      return "failed to create array for field 'int_values'";
    }
    auto array_ptr = ros_message->int_values.data;
...
static size_t _TestArrayRequest_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestArrayRequest_Request(
    full_bounded, 0);
}
...
static size_t _TestArrayRequest_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestArrayRequest_Response(
    full_bounded, 0);
}
