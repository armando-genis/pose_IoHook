...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/inference_webcam"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/inference_webcam/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/inference_webcam/environment/path.sh"
