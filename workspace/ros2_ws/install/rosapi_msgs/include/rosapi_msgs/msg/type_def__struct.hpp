...
#ifndef ROSAPI_MSGS__MSG__TYPE_DEF__STRUCT_HPP_
#define ROSAPI_MSGS__MSG__TYPE_DEF__STRUCT_HPP_
...
struct TypeDef_
{
  ...
  explicit TypeDef_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TypeDef_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : type(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // ROSAPI_MSGS__MSG__TYPE_DEF__STRUCT_HPP_
