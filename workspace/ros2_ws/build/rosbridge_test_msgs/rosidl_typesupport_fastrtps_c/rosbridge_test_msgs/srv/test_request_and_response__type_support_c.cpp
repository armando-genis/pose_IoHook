...
static size_t _TestRequestAndResponse_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Request(
    full_bounded, 0);
}
...
static size_t _TestRequestAndResponse_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__srv__TestRequestAndResponse_Response(
    full_bounded, 0);
}
