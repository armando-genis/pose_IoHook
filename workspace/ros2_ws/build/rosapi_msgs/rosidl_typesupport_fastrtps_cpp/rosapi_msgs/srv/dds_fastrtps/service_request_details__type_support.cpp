...
#include "rosapi_msgs/srv/service_request_details__rosidl_typesupport_fastrtps_cpp.hpp"
#include "rosapi_msgs/srv/service_request_details__struct.hpp"
...
{
  return max_serialized_size_ServiceRequestDetails_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_ServiceRequestDetails_Response(full_bounded, 0);
}
