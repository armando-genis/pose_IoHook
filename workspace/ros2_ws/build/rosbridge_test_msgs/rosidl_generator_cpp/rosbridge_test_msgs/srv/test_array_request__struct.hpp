...
#ifndef ROSBRIDGE_TEST_MSGS__SRV__TEST_ARRAY_REQUEST__STRUCT_HPP_
#define ROSBRIDGE_TEST_MSGS__SRV__TEST_ARRAY_REQUEST__STRUCT_HPP_
...
struct TestArrayRequest_Request_
{
  ...
  explicit TestArrayRequest_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit TestArrayRequest_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
struct TestArrayRequest_Response_
{
  ...
  explicit TestArrayRequest_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit TestArrayRequest_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // ROSBRIDGE_TEST_MSGS__SRV__TEST_ARRAY_REQUEST__STRUCT_HPP_
