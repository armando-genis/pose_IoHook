...
#include "rosbridge_test_msgs/srv/send_bytes__rosidl_typesupport_fastrtps_cpp.hpp"
#include "rosbridge_test_msgs/srv/send_bytes__struct.hpp"
...
static size_t _SendBytes_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_SendBytes_Request(full_bounded, 0);
}
...
static size_t _SendBytes_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_SendBytes_Response(full_bounded, 0);
}
