...
#ifndef ROSAPI_MSGS__SRV__GET_ACTION_SERVERS__FUNCTIONS_H_
#define ROSAPI_MSGS__SRV__GET_ACTION_SERVERS__FUNCTIONS_H_
...
#endif  // ROSAPI_MSGS__SRV__GET_ACTION_SERVERS__FUNCTIONS_H_
