...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_Goal * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_Goal *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Goal));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_Goal__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_Goal *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Goal));
    if (!data) {
      return false;
    }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_Goal__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_Goal__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Goal__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_Result * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_Result *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Result));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_Result__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_Result *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_Result__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_Result__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Result__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage * msg = (rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage__Sequence__init(rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage *)calloc(size, sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage__Sequence * array = (rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage__Sequence *)malloc(sizeof(rosbridge_test_msgs__action__TestFeedbackAndResult_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
