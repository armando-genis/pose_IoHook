...
#include "rosapi_msgs/msg/type_def__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // fieldarraylen
#include "rosidl_generator_c/primitives_sequence_functions.h"  // fieldarraylen
#include "rosidl_generator_c/string.h"  // constnames, constvalues, examples, fieldnames, fieldtypes, type
#include "rosidl_generator_c/string_functions.h"  // constnames, constvalues, examples, fieldnames, fieldtypes, type
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: fieldnames
  {
    ...
    if (ros_message->fieldnames.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->fieldnames);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->fieldnames, size)) {
  ...
  // Field name: fieldtypes
  {
    ...
    if (ros_message->fieldtypes.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->fieldtypes);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->fieldtypes, size)) {
  ...
  // Field name: fieldarraylen
  {
    ...
    if (ros_message->fieldarraylen.data) {
      rosidl_generator_c__int32__Sequence__fini(&ros_message->fieldarraylen);
    }
    if (!rosidl_generator_c__int32__Sequence__init(&ros_message->fieldarraylen, size)) {
  ...
  // Field name: examples
  {
    ...
    if (ros_message->examples.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->examples);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->examples, size)) {
  ...
  // Field name: constnames
  {
    ...
    if (ros_message->constnames.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->constnames);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->constnames, size)) {
  ...
  // Field name: constvalues
  {
    ...
    if (ros_message->constvalues.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->constvalues);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->constvalues, size)) {
