...
bool rosapi_msgs__srv__get_ros_version__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "rosapi_msgs.srv._get_ros_version.GetROSVersion_Request",
...
bool rosapi_msgs__srv__get_ros_version__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "rosapi_msgs.srv._get_ros_version.GetROSVersion_Response",
  ...
  {  // distro
    ...
    rosidl_generator_c__String__assign(&ros_message->distro, PyBytes_AS_STRING(encoded_field));
