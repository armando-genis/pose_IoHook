...
#include "rosbridge_test_msgs/action/test_goal_feedback_and_result__rosidl_typesupport_fastrtps_c.h"
...
static size_t _TestGoalFeedbackAndResult_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Goal(
    full_bounded, 0);
}
...
static size_t _TestGoalFeedbackAndResult_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Result(
    full_bounded, 0);
}
...
static size_t _TestGoalFeedbackAndResult_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_Feedback(
    full_bounded, 0);
}
...
// already included above
// #include "rosbridge_test_msgs/action/test_goal_feedback_and_result__functions.h"  // goal
...
static size_t _TestGoalFeedbackAndResult_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _TestGoalFeedbackAndResult_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _TestGoalFeedbackAndResult_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Request(
    full_bounded, 0);
}
...
// already included above
// #include "rosbridge_test_msgs/action/test_goal_feedback_and_result__functions.h"  // result
...
static size_t _TestGoalFeedbackAndResult_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_GetResult_Response(
    full_bounded, 0);
}
...
// already included above
// #include "rosbridge_test_msgs/action/test_goal_feedback_and_result__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/uuid__functions.h"  // goal_id
...
static size_t _TestGoalFeedbackAndResult_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rosbridge_test_msgs__action__TestGoalFeedbackAndResult_FeedbackMessage(
    full_bounded, 0);
}
